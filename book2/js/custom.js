...
function montaClass(theClass, b) {
	...
	if (theClass.indexOf("quiz10") !== -1)  {
        ...
        return "<div class='class_container'><iframe src='http://www.welbe.com.br/class/" + theClass.replace("XXX", "/").replace("AAA", "/").substring(7) + ".aspx' style='width:770px;height:570px;' frameborder=0 scrolling=no></iframe></div>"

	} else {

        return "<div class='class_container'><iframe src='http://www.welbe.com.br/class/" + theClass.replace("XXX", "/").replace("AAA", "/").substring(6) + ".aspx' style='width:770px;height:570px;' frameborder=0 scrolling=no></iframe></div>"
