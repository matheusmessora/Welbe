...
function montaClass(theClass, b) {
    ...
    if (b) {
        //alert("<div class='class_container'><iframe src='http://www.welbe.com.br/class/Book3" + theClass.replace("XXX", "/").replace("AAA", "/") + ".aspx' style='width:770px;height:570px;' frameborder=0 scrolling=no></iframe></div>")
        return "<div class='class_container'><iframe src='http://www.welbe.com.br/class/Book3" + theClass.replace("XXX", "/").replace("AAA", "/") + ".aspx' style='width:770px;height:570px;' frameborder=0 scrolling=no></iframe></div>"
        ///return "<div class='class_container'><iframe src='http://localhost:53534/HTML/Book3" + theClass.replace("XXX", "/").replace("AAA", "/") + ".aspx' style='width:770px;height:570px;' frameborder=0 scrolling=no></iframe></div>"
